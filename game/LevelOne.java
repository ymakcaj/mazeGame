 ...
 * <li>Each valid movement costs one uniot of energy.
 * Game over when the energy level of the player is equals to zero.
 */
 ...
 class LevelOne implements KeyListener {
    ...
    /**
     * Initializes L1 by adding game objects to the map.
     */
    private void init() {
        // init game objects
    ...
    /**
     * Updates the game's stats if the player finds specified items in the game.
     */
